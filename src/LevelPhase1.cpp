...
//--------------------------------------------------------------
void LevelPhase1::keyPressed(int key) {
...
//--------------------------------------------------------------
void LevelPhase1::keyReleased(int key) {

}

//--------------------------------------------------------------
void LevelPhase1::mouseMoved(int x, int y) {

}

//--------------------------------------------------------------
void LevelPhase1::mouseDragged(int x, int y, int button) {

}

//--------------------------------------------------------------
void LevelPhase1::mousePressed(int x, int y, int button) {

}

//--------------------------------------------------------------
void LevelPhase1::mouseReleased(int x, int y, int button) {
	switch (button)
	{
...
//--------------------------------------------------------------
void LevelPhase1::mouseEntered(int x, int y) {

}

//--------------------------------------------------------------
void LevelPhase1::mouseExited(int x, int y) {

}

//--------------------------------------------------------------
void LevelPhase1::windowResized(int w, int h) {
...
//--------------------------------------------------------------
void LevelPhase1::gotMessage(ofMessage msg) {

}

//--------------------------------------------------------------
void LevelPhase1::dragEvent(ofDragInfo dragInfo) {

}

Vector3D LevelPhase1::GetLaunchDirection(float x, float y)
{
...
void LevelPhase1::GeneratePrevisualization(Vector3D initialPosition)
{
	float particleSpeed;
